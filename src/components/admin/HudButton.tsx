...
const variantStyles = {
  cyan: {
    background:
      'linear-gradient(135deg, rgba(0, 255, 255, 0.1), rgba(0, 100, 255, 0.1))',
  ...
  magenta: {
    background:
      'linear-gradient(135deg, rgba(255, 0, 255, 0.1), rgba(255, 0, 100, 0.1))',
  ...
  yellow: {
    background:
      'linear-gradient(135deg, rgba(255, 255, 0, 0.1), rgba(255, 150, 0, 0.1))',
...
export function HudButton({
  ...
  return (
    <button
      ...
      className={`relative w-full overflow-hidden rounded-lg border p-4 font-semibold text-white transition-transform duration-200 ease-in-out hover:scale-[0.98] active:scale-[0.96] ${className || ''}`}
      style={{
